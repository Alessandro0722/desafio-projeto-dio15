...
create table departament(
    ...
    departament_ifbk_1 varchar(15) not null,
...
-- 'def', 'azure_company', 'departament_ibfk_1', 'azure_company', 'departament', 'FOREIGN KEY', 'YES'
...
create table dept_locations(
    ...
    fk_dept_locations varchar(15) not null,
